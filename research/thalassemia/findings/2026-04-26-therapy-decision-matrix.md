# Finding: Therapy Decision Matrix

Date checked: 2026-04-26
Evidence label: Therapy comparison

## Working Conclusion

No therapy should be discussed as universally relevant to all thalassemia
patients. Each option depends on subtype, age, transfusion pattern, genotype,
organ status, immune status, access, and cost.

## Matrix

| Option | Main purpose | Strong fit | Key blockers |
| --- | --- | --- | --- |
| Transfusion + chelation | Survival and organ protection | TDT baseline care | Iron overload, blood supply, antibodies, adherence |
| Hydroxyurea | HbF induction in selected settings | Some beta/HbE-beta cases | Variable response, monitoring, not definitive cure |
...
- TDT or NTDT classification from real transfusion history.
- Age and transplant fitness.
- Iron overload and organ status.
- Antibody and autoimmune history.
- Current chelation and liver tests.
- Local availability, reimbursement, and referral center access.

## Research Implication

Nakafa Lab should prioritize two parallel paths:

1. Access path: determine whether any existing therapy is medically relevant and
   practically reachable in Indonesia.
...
- [Luspatercept BELIEVE trial, PubMed PMID 32212518](https://pubmed.ncbi.nlm.nih.gov/32212518/)
