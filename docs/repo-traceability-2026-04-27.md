...
| --- | ---: | --- |
| `data/` | 452 | source snapshots and extracted evidence records |
| `research/` | 135 | findings, assays, hypotheses, case-context, Islamic lane, and research maps |
| `docs/` | 11 | operating docs, status journals, security, setup, and hygiene |
...
| root config/docs | 9 | repo config, README, agent guide, Python project files |

## File-Type Trace

| Type | Files | Meaning |
| --- | ---: | --- |
| `.json` | 398 | PubMed, ClinicalTrials.gov, PubChem, ChEMBL, BPOM, and registry snapshots |
| `.md` | 151 | docs, findings, assays, hypotheses, Quran notes, templates |
| `.xml` | 37 | PubMed or PMC abstract/full-text source snapshots |
...
| `.ipynb` | 3 | small reproducible notebooks |
...
| --- | ---: | --- |
| `data/literature/` | 236 | literature, full-text extracts, PubMed XML/JSON, and supplementary source tables |
...
| --- | ---: | --- |
| `research/thalassemia/findings/` | 79 | small source-backed findings and decision notes |
...
| `research/thalassemia/notebooks/` | 4 | reproducible scoring and literature-matrix experiments |
| `research/thalassemia/references/` | 1 | source registry |
| `research/thalassemia/README.md` | 1 | disease program entrypoint |
| `research/islamic/` | 26 | Quran, hadith, tafsir, ethics, and natural-material anchor notes |
