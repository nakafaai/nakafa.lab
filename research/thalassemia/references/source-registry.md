...
| Natural products | [Curcuminoid analog PubChem snapshots](../../../data/chemistry/pubchem/curcuminoid-analogs/) | Compound-property snapshots for `Cur`, `DMC`, and `BDMC`; trienone analogs lacked first-pass exact PubChem hits. |
| Natural products | [Curcuminoid analog ChEMBL snapshots](../../../data/chemistry/chembl/curcuminoid-analogs/) | ChEMBL search snapshots used to mark noisy identity results for trienone analogs. |
