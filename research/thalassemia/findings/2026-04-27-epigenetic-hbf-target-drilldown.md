...
- `DNMT1`, where decitabine is proof-of-biology but has safety and delivery
  limitations;
...
| 3 | `DNMT1` depletion / decitabine | Human thalassemia intermedia and HbE/beta-thalassemia evidence supports HbF induction. | Cytotoxicity, marrow suppression, dosing complexity, and long-term risk concerns. |
