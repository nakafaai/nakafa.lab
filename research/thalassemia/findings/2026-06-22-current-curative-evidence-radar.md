...
fertility outcomes, and only two-case Indonesia execution evidence prevent
general affordable-cure promotion. A newly indexed long-term meta-analysis and its
...
mutually exclusive cause-specific mortality rates. A newly integrated Malaysian
cohort now adds a Southeast Asian long-horizon outcome and observed-burden
benchmark. It includes 115 consecutive children, 96 with matched-sibling
donors, followed for a median of 18 years. The full cohort's reported 15-year
overall survival was 83.5% and thalassemia-free survival was 71.3%, alongside
18 transplant-related deaths, 30 graft failures, 30 grade II to IV acute
...
two pediatric matched-sibling beta-thalassemia major transplants at one Jakarta
center. Both reached 100% donor chimerism at day 28 and both developed
veno-occlusive disease. The two selected cases establish local execution, not
transfusion independence, durability, routine availability, scale, safety, or
affordability. Two 2026 primary studies move RSUP Dr. Kariadi beyond a capacity
signal by documenting 45 adult malignant-disease HSCT procedures from 2013-2023
and three allogeneic acute-leukemia donor-recipient pairs from 2023-2024. The
cost study maps transplant phases but contains two incompatible calculation
sets, so Kariadi is an execution-and-cost-audit benchmark, not a thalassemia,
safety, affordability, or payer result. A June 2026 licensing assessment still
has no public decision identifier or thalassemia-specific scope. A new 119-person
pre-HSCT TDT fertility
...
A formal NEJM correction now tightens the reni-cel HBG-promoter-editing
benchmark. It limits the day-42 claim to neutrophil engraftment, restores the
actual common grade 3 or 4 adverse-event counts, and corrects the Discussion's
...
does not report a beta-thalassemia donor denominator, erythroid or globin
endpoints, processing cost, or Indonesia access. The route therefore stays
outside the current quote as
...
- **Fact - production requirement:** BRIN identifies Astatine-211 as requiring
  an alpha beam with a reported 19.36 MeV threshold. IAEA Radioisotopes and
  Radiopharmaceuticals Reports No. 4 instead gives a 20.718 MeV reaction
  threshold and a 21.0 to 28.6 MeV practical bismuth-209(alpha,2n) window. It
  limits alpha energy to about 28 MeV to control the radiotoxic polonium-210
  impurity pathway associated with astatine-210 co-production and gives a
  7.214-hour Astatine-211 half-life.
...
- **Conflict:** BRIN's 19.36 MeV threshold differs from the IAEA's 20.718 MeV
  reaction threshold and 21.0 to 28.6 MeV practical window. Keep the source
  values separate and use the practical window for a facility capability gate.
  The IAEA directory is under revision and its Indonesian records were last
  modified from 2018 through 2023. BRIN's inventory ends in 2024. These sources
  do not prove that no unlisted, upgraded, or planned alpha-capable facility
  exists.
- **Hypothesis:** A named local cyclotron qualified for the 21.0 to 28.6 MeV
  alpha window plus bismuth-target recovery, antibody radiolabeling, impurity
  control, same-day release, and quality-control workflow could make the isotope
  component reproducible enough for a busulfan comparison.
...
- **Open question:** Can a named Indonesian facility verify the 21.0 to 28.6
  MeV alpha operating window and current, bismuth-target handling, Astatine-211
  recovery and antibody labeling, sterile release, astatine-210 and polonium-210
  impurity control, batch yield, hours to use, regulatory scope, and
  activity-based cost?
...
- **Next decisive action:** A radiopharmacy and health-economics owner should
  obtain one public-safe facility capability record covering the qualified alpha
  operating window, impurity control, production, release, logistics, failure,
  regulatory, and cost chain. No patient action or treatment recommendation
  follows.
...
**Question:** Does the Malaysian 115-child TDT HSCT cohort close the Southeast
Asian long-term outcome and affordability gaps enough to promote
matched-sibling HSCT or an ATG-containing conditioning regimen beyond
benchmark-only status?
...
- **Mechanism and scope:** Myeloablative conditioning followed by allogeneic
  donor HSPC infusion replaces ineffective recipient erythropoiesis. The
  observed population is 115 children with TDT transplanted at one Malaysian
  center from 1987 through 2023, not a current-protocol or pure matched-sibling
  cohort.
- **Evidence tier:** Direct human outcome evidence from a retrospective,
  single-center, nonrandomized cohort spanning 36 years.
- **Fact - cohort and donor scope:** PMID `42466977`, DOI
  `10.4103/singaporemedj.SMJ-2024-235`, reports 115 consecutive children and
  128 transplant procedures. Ninety-six children received matched-sibling
  grafts, 13 received matched-unrelated umbilical cord blood, and six received
  haploidentical family grafts.
- **Fact - long-horizon outcome:** At median follow-up of 18 years, range 1 to
  ...
  of 86.5% and 72.9%, but provides no calendar-era split or number-at-risk table.
- **Fact - observed burden:** The report gives 18 transplant-related deaths,
  including 14 within 100 days; 30 graft failures, including 17 primary and 13
  secondary; 30 grade II to IV and 10 grade III to IV acute
...
- **Hypothesis:** A current, standardized matched-sibling marrow program in
  ...
  gene-cell therapy.
- **Affordability and access:** The paper cites a prior Malaysian estimate for
  lifetime standard care but reports no HSCT delivery cost, payer payment,
...
**Question:** Does the corrected reni-cel paper support promotion beyond an
early clinical HBG-promoter-editing benchmark?

**Decision:**
`hold_reni_cel_at_corrected_early_clinical_hbg_promoter_editing_benchmark_only`.

- **Fact - mechanism and scope:** The
  [primary report](https://doi.org/10.1056/NEJMoa2501277) is a phase 1-2,
  multicenter, open-label, single-group study of autologous CD34-positive HSPCs
  edited with AsCas12a at BCL11A binding sites in the `HBG1` and `HBG2`
  promoters. It reports nine adults with TDT: three beta-zero/beta-zero, one
  beta-plus/beta-plus with homozygous IVS-I-110 G-to-A, four
  beta-zero/beta-plus, and one HbE/beta-zero.
- **Fact - corrected engraftment:** The
  [NEJM correction](https://doi.org/10.1056/NEJMx260013) states that all nine
  had neutrophil engraftment by day 42. It removes platelet engraftment from
  that claim; Table 1 reports platelet engraftment from day 23 to day 49.
- **Fact - corrected safety:** The correction replaces incorrect narrative
  ...
  participants and six serious events in four participants.
- **Fact - efficacy boundary:** All nine participants were transfusion-free at
  ...
  22.7 months. Six could be evaluated for at least 12 months of transfusion
  independence. The study ended early and the analysis was not prespecified.
- **Evidence tier and safety risk:** This is sponsor-funded early clinical
  evidence after full myeloablative busulfan conditioning. No death or
  malignancy was reported by the cutoff, but the cohort and follow-up cannot
  resolve late genomic, clonal, marrow, organ, endocrine, fertility, or
  malignancy risk.
- **Conflict:** Public
  [`NCT05444894`](https://clinicaltrials.gov/study/NCT05444894) remains active,
  not recruiting, with no posted results, while the paper states that
  development was discontinued and the study terminated early. The enrolling
  by invitation 15-year [`NCT06363760`](https://clinicaltrials.gov/study/NCT06363760)
  record has no posted results.
- **Hypothesis:** Participant-level long-term follow-up can retain the modality
  as a mechanism and durability comparator if editing, HbF, hematopoiesis, and
  transfusion independence remain stable without unacceptable late harm.
- **Interpretation:** The corrected record remains useful as an HBG-promoter
  editing efficacy benchmark. It does not establish an active program, durable
  cure, acceptable long-term safety, affordability, Indonesia access, or
  suitability.
- **Affordability and access:** The sources report no itemized manufacturing
  cost, scaled commercial manufacturing-failure rate, delivered price,
  Indonesia authorization, center capacity, payer coverage, or total follow-up
  cost. Discontinued development prevents use as a current access route.
- **Open question:** What are the corrected participant-level platelet,
  product-related, busulfan-related, transplant-related, five-year efficacy,
  late genomic, malignancy, marrow, organ, endocrine, fertility,
  manufacturing-failure, and delivered-cost outcomes?
- **Falsification criterion:** Deprioritize even the benchmark if corrected
  ...
  late safety or manufacturing outcomes make the risk-benefit profile
  unacceptable. Do not promote an affordable route without itemized cost and a
  reproducible access pathway.
- **Next decisive action:** The research evidence owner should reconcile the
  correction with the abstract, Results narrative, Table 1, Table 2, parent
  registry, and long-term follow-up, then obtain a complete participant-level
  denominator separating product, busulfan, transplant, and late follow-up
  harms.
...
beta-thalassemia cell-source gap enough to enter Nakafa Lab's current affordable
HbF and globin-chain-balance quote?

**Decision:**
`hold_apheresis_waste_cd34_hspcs_at_preclinical_hemoglobinopathy_material_recovery_benchmark_only`.
This replaces the morning promotion label after a source-depth audit. All
...
- **Fact - source and design:** BioRxiv version 1, DOI
  ...
  blood that would otherwise be discarded after clinical procedures. The
  abstract frames the work around sickle cell disease and beta-thalassemia,
  describes immunomagnetic selection adapted for hemoglobinopathy specimens,
  and evaluates a separate microfluidic pilot.
- **Fact - population:** The abstract does not report the total patient count,
  independent donor count, diagnosis-specific counts, beta-thalassemia donor
  count, genotype, phenotype, or repeated-specimen structure.
...
- **Evidence tier:** This is a version 1, non-peer-reviewed preprint. The
  official page and API available to this audit exposed the abstract and
  metadata, but no source-linked donor manifest, full results table, supplement,
  or donor-level dataset was verified. The abstract does not report how many
  donors had beta-thalassemia,
...
- **Conflict:** The title and conclusion frame a beta-hemoglobinopathy biobank,
  but "similar across diagnoses" does not identify a beta-thalassemia donor or
  diagnosis-specific denominator. The article page declares no competing
  interest and lists two funders, while the official API `funder` field is
  `NA`.
- **Hypothesis:** A qualified center with existing apheresis infrastructure,
  ...
  lower-cost, multi-donor primary-cell model for the Nakafa assay funnel.
- **Interpretation:** The abstract supports a hemoglobinopathy
  material-recovery benchmark. It does not verify a beta-thalassemia material
  source and does not enter the current quote. It does not demonstrate a
  therapy, cure, transfusion independence, affordability, patient access, or
...
- **Falsification criterion:** Do not enter a quote or experiment if
  beta-thalassemia donor provenance and independent-patient and specimen
  denominators cannot be confirmed. Remove or deprioritize the route if it
...
- **Next decisive action:** The research evidence owner should obtain a
  ...
  should a lab-operations owner price a paired feasibility line. No outreach,
  patient action, or sample routing is authorized by this decision.
...
- **Fact - endpoint and design:** PMID `42052597` reports mean neutrophil
  engraftment at 14.29 days and mean platelet engraftment at 13.53 days. The
  study selected complete records from one center and did not report a complete
  attempted denominator, survival, relapse, or long-term safety.
- **Fact - cost evidence:** Primary mixed-method study PMID `42345166` uses
  ...
  Donors were related or haploidentical family members. The endpoint was unit
  cost, not clinical efficacy or safety.
- **Mechanism and genotype or phenotype scope:** The studies cover autologous
  and allogeneic HSCT for adult malignancies. The cost paper describes
...
- **Resolved source tension:** The cohorts establish that Kariadi performed HSCT
  before the June 2026 licensing assessment. They do not identify whether the
  later assessment concerned a new license, renewal, scope expansion, or another
  administrative step. Historical execution is not current authorization.
- **Unresolved numeric conflict:** The cost paper's abstract and narrative report
  ...
  Rp389,880,946 and Rp49,717,690. Its phase components and tariff cost-recovery
  ratios also conflict between the abstract, narrative, and tables. Neither set
  may be selected without a correction.
- **Evidence tier and safety risk:** This is retrospective, single-center clinical
  and costing evidence. No complete mortality, graft-failure, VOD, infection,
  GVHD, endocrine, fertility, organ, or long-term denominator was reported.
  Technical execution does not establish acceptable safety.
...
- **Affordability and access:** The cost study is more informative than a generic
  price range, but its arithmetic conflict blocks use as an affordability
  estimate, hospital quote, or payer amount. Its statement that HSCT was outside
  national insurance coverage is study context, not a current BPJS decision.
- **Falsification criterion:** Remove the execution benchmark if the center-level
  ...
  lane audit-only until a correction reconciles phase totals, formulas,
  inclusions, currency year, and payer scope. Do not promote the thalassemia
  route without durable transfusion independence, acceptable long-term safety,
  and reproducible delivered cost in the relevant population.
...
- **Fact - regimen and endpoint:** The report states `Bu4Cy2+ATG` for one case
  and `Bu4Cy4+ATG` for the other. Neutrophil engraftment occurred on days 11
  and 12, platelet engraftment on days 43 and 25, and both had 100% donor
  chimerism at day 28. These regimen strings are reported evidence, not a
  protocol recommendation.
- **Safety risk:** Both cases developed veno-occlusive disease despite
  ursodeoxycholic-acid prophylaxis and received defibrotide plus
  low-molecular-weight heparin. Two events among two selected cases are a
  center-level safety signal, not a stable incidence estimate.
- **Evidence tier:** Primary two-case conference report with no comparator,
  complete attempted denominator, or reported transfusion-independence,
  mortality, graft-failure, infection, GVHD, fertility, endocrine, organ,
  quality-of-life, or cost outcome beyond the short engraftment window.
- **Resolved source overlap:** The 2023 APBMT abstract describes the first case
  during pre-HSCT screening. The 2024 report includes two transplanted cases.
  These are sequential reports with at least one overlapping case, not three
  independent transplants.
- **Fact - current facility signal:** The hospital's current facility page
  lists a pediatric blood-stem-cell transplant unit with trained specialist
  staff, apheresis equipment, sterile recovery rooms, and diagnostic support.
  It does not publish current case volume or outcomes.
- **Affordability and access:** A September 2025 hospital article gives a
  ...
  directly comparable with the 2026 LMIC cohort's USD 8,000-10,000 mean because
  setting, included services, and follow-up differ or are unstated.
- **Hypothesis:** A governed Indonesian pediatric matched-sibling HSCT program
  ...
  if the complete attempted denominator, pharmacokinetic monitoring, long-term
  outcomes, and delivered cost are measured prospectively.
- **Interpretation:** Local execution is now established at two-case resolution.
  The two VOD events and missing denominator, durability, capacity, and cost
  evidence block route promotion.
...
- **Falsification criterion:** Remove the execution benchmark if the center
  cannot confirm an ongoing governed service or complete attempted denominator.
  Remove the leading affordable-route label if modern follow-up shows
  unacceptable death, graft failure, VOD, infection, GVHD, endocrine or
...
- **Fact and source link:** The peer-reviewed Molecular Therapy paper
  (PMID `41693207`; DOI `10.1016/j.ymthe.2026.02.017`) reports hemobeglogene
  autotemcel, or hemo-cel. Hemogen identifies hemo-cel as HGI-001, and the
  sponsor's publication page links the paper to `NCT04592458`.
  ClinicalTrials.gov records that identifier as an alias of `NCT05745532`.
- **Fact and scope:** The single-center, single-arm pilot treated five children
  with transfusion-dependent beta-thalassemia, including three with
  beta-zero/beta-zero genotypes. The abstract reports median follow-up of 34.7
  months; all five remained transfusion independent for more than 26 months,
  with a median of 34.3 months. It reports median neutrophil and platelet
  engraftment on days 18 and 13, sustained HbA-T87Q and vector copy number, and
  no unexpected adverse events, clonal dominance, or replication-competent
  lentivirus during that follow-up.
- **Evidence tier and limitation:** This is peer-reviewed early clinical
  outcome evidence, not a registry-only signal. It is still a five-person,
  non-randomized cohort without an untreated comparator. Three authors disclose
  a related patent and one is Hemogen's founder. The indexed abstract does not
  provide a complete adverse-event table, manufacturing-failure denominator,
  itemized cost, or long-term malignancy denominator.
- **Resolved provenance gap:** The five-person outcome statement is now linked
  to a primary paper. The earlier two-person preprint remains a prior data cut
  and must not be counted as two additional participants.
- **Unresolved source conflicts:** The paper calls the study phase 1/2 and
  reports five treated participants, while the current aliased registry record
  labels it early phase 1, estimates ten participants, remains recruiting, and
  has no posted results. The new phase 2 narrative says four of five remained
  transfusion independent for more than two years, whereas the paper abstract
  says all five did so for more than 26 months. The registry's broad statement
  of no severe adverse events must not replace the paper's narrower
  no-unexpected-event wording or erase conditioning-related serious events
  described in the sponsor's publication summary.
...
- **Safety:** The absence of unexpected events, clonal dominance, or
  replication-competent lentivirus in five participants at about three years
  does not remove busulfan toxicity, cytopenia, infection, organ toxicity,
  manufacturing failure, insertional risk, or the need for long-term
  integration surveillance.
- **Affordability and access:** Sponsor pages describe localized manufacturing,
  but no reviewed primary or official source itemizes product, equipment,
  technology-transfer, conditioning, inpatient, surveillance, or total
  delivered cost. The Hong Kong phase 2 record remains not yet recruiting with
  no listed site or posted results. Neither point establishes Indonesia
  authorization, payer coverage, access, or affordability.
- **Hypothesis:** A prospectively defined, larger phase 2 cohort could strengthen
  the early clinical benchmark if it reproduces transfusion independence across
  genotypes with complete treated and evaluable denominators, conditioning
  toxicity, vector-integration safety, manufacturing failures, and delivered
  cost.
- **Open question:** Will the larger cohort reproduce the five-person signal
...
- **Next decisive action:** Obtain the full paper and supplement through an
  ...
  aliased registry record, and extract all serious events by conditioning versus
...
- **Current-source check:** On July 25, an alias-expanded PubMed query returned
  PMID `41693207`; the previous exact HGI-001/trial-ID search missed the hemo-cel
  alias. A July 24-25 PubMed entry-date query returned three records that did
  not change the HGI-001 decision. ClinicalTrials.gov returned no new
  beta-thalassemia study or posted result from July 24 onward and one
  non-curative care-management update.
...
**Question:** Does current `CD117` epitope-shielding evidence resolve the
conditioning barrier exposed by pediatric exa-cel?
...
- **Fact:** In a non-peer-reviewed primary preprint, `CIM058` blocked wild-type
  `CD117` while prime-edited `CD117 E73K` healthy-donor HSPCs resisted depletion.
  ...
  enriched shielded cells, improved globin-chain balance and erythroid
  maturation, reduced reticulocytosis and splenic iron, and reduced spleen
  size. Methods report two same-genotype donor sources; this is not a patient
  outcome study.
- **Hypothesis:** Targeted depletion plus epitope-shielded HSPCs can replace
  busulfan while preserving durable, multilineage engraftment after antibody
  withdrawal.
- **Interpretation:** The study moves conditioning reduction from an abstract
  requirement to a falsifiable preclinical route. It does not prove durable
  chimerism after stopping antibody, clinical safety, transfusion independence,
  access, or affordability. The NBSGW model permits unconditioned engraftment
  and partially rescued phenotype without `CIM058`, which limits causal and
  translational inference.
- **Open question:** Will an immunocompetent large-animal study retain
  clinically relevant multilineage chimerism after antibody withdrawal without
  genotoxic conditioning, unacceptable genomic or immune toxicity, or intensive
  supportive care?
- **Current-source check:** On 2026-07-18, `NCT05356195` remained active, not
  ...
  posted from July 17 onward. A PubMed July 17-18 entry-date query returned
  three records: this preprint, an EHA/EBMT gene-therapy selection consensus,
  and an observational endocrinopathy study. The consensus reinforces price,
  availability, and resource constraints but adds no new efficacy outcome.
- **Falsification criterion:** Deprioritize the route if the antibody-withdrawal
  experiment fails durable multilineage chimerism, full safety is unacceptable,
  or a costed process does not meet the program threshold.
- **Next decisive action:** A transplant-conditioning owner should obtain the
  complete nonhuman-primate dataset cited as preliminary and require a
  controlled antibody-withdrawal, safety, supportive-care, and cost comparison
  before clinical or affordable-cure promotion.
