...
gene addition, and CRISPR-enabled fetal hemoglobin reactivation. The China
\texttt{VGB-Ex01} registry record shows that the integrated HbF, alpha-chain
burden, red-cell survival, hemolysis, and transfusion-reduction logic already
exists in an ex vivo editing benchmark. The remaining practical Nakafa Lab gap
is therefore narrower: an affordable non-editing validation program around
fetal hemoglobin, globin-chain balance, erythroid maturation, mature red-cell
safety, iron overload, and specialist-reviewed eligibility.
