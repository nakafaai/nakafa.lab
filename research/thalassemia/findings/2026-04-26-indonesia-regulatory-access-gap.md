# Finding: Indonesia Regulatory and Access Gap

Date checked: 2026-04-26
Evidence label: Access gap

## Working Conclusion

We have not yet verified Indonesian regulatory approval or routine access for
mitapivat, luspatercept, Zynteglo, or Casgevy. This must be treated as an open
access question, not an assumption.
...
- Which Indonesian centers can evaluate HSCT or gene therapy eligibility for
  thalassemia.

## Next Verification Targets

- BPOM product database or formal inquiry.
- BPJS coverage details for disease-modifying thalassemia drugs.
- RSAB Harapan Kita / NGI thalassemia program.
- Hematology centers with thalassemia and transplant expertise.
- BPJS and hospital requirements for referral, genetic testing, MRI T2*, and
  advanced therapy consultation.
