...
| 4 | Assay-ready HbF screen | directly tests cure-like endpoint | needs lab partner and assay access |
| 5 | Propolis red-cell oxidative-stress lane | red-cell oxidative-stress evidence exists | no direct HbF or thalassemia evidence yet |
| 6 | Royal jelly oxidative-stress lane | general oxidative/inflammation evidence exists | no direct HbF or thalassemia evidence yet |
| 7 | Melittin/bee venom lane | biologically active venom molecule | hemolysis and anaphylaxis risk; hazard-first only |
...
The first five deep-dive files are now:
