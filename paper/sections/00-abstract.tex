...
\texttt{CS-101} phase 1 base-editing report and \texttt{VGB-Ex01} registry
record show that HbF-restoring ex vivo editing already has close clinical and
mechanistic benchmarks. The remaining practical Nakafa Lab gap is therefore
narrower: an affordable non-editing validation program around fetal hemoglobin,
globin-chain balance, erythroid maturation, mature red-cell safety, iron
overload, and specialist-reviewed eligibility.
