...
Do not contact a lab yet. The June 2 first quote request table remains the
...
If founder approval is given later, the ask should be limited to whether a
qualified lab can quote a public-safe preclinical feasibility panel with model,
readout, cost, timeline, and raw-data-format details. It must not ask for
patient treatment, dosing, import, travel, trial screening, or patient-specific
selection.

## Boundary

This finding does not provide diagnosis, treatment advice, supplement advice,
dosing, purchase guidance, import guidance, trial-screening guidance, or lab
contact permission.

## Sources

- [June 7 assay gate](../assays/2026-06-07-lab-outreach-approval-gate.md)
